...
import { d as createLucideIcon, e as useAuth, s as supabase, B as Button, T as TriangleAlert, R as RefreshCw } from "./AppContent-D_6GRQiW.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-BxAEd2e_.js";
import { B as Badge } from "./badge-CYSKJY1y.js";
import { t as toast } from "./index-DnZbmy1q.js";
import { G as GlowingEffect } from "./glowing-effect-BUdPYysw.js";
import { I as ImageSwiper } from "./image-swiper-JrhmVidy.js";
import { m as motion } from "./proxy-wAhnH72j.js";
import { C as Camera } from "./camera-DMgagIrm.js";
import { A as AnimatePresence } from "./index-YHKUL8bc.js";
import { L as LoaderCircle } from "./loader-circle-EMsObEE9.js";
import { L as Layers } from "./BottomNav-BR9tYivk.js";
import { U as Upload } from "./upload-BoX8ZzdR.js";
...
function FashionHero({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-2 py-6 md:py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6 relative overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:order-1 flex flex-col justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-20 h-20 md:w-24 md:h-24", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "100%", height: "100%", viewBox: "0 0 100 100", className: "-rotate-90", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "goldArc2", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#C6A55C" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#E8D5A3" })
            ] }) })
          ] }),
      ...
      actualColors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Colors:" }),
        actualColors.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-zinc-800/40 border border-zinc-700/30 text-xs text-foreground/70", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-2.5 h-2.5 rounded-full inline-block ${colorSwatchMap[c] || "bg-gray-400"}` }),
          c
        ] }, i))
      ] }),
